...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'User successfully authenticated, JWT provided' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get the profile of the authenticated user' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Profile retrieved successfully' }),
